...
import {
  ...
  ArrowRight, ShoppingBag, XCircle,
} from 'lucide-react';
import { Button } from '@/components/ui/Button';

const STEPS = [
  { icon: CheckCircle, label: 'Work Order Received', desc: "We've received your work order" },
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-pbs-gray-900 dark:text-white">Something went wrong</h1>
          <p className="text-pbs-gray-500 dark:text-pbs-gray-400 mt-2">
            We couldn&apos;t find your work order. Please try again.
          </p>
        </div>
        <Link href="/checkout">
          <Button variant="primary" size="lg">Return to Work Order</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-3xl p-8 sm:p-12 text-center space-y-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-pbs-gray-900 dark:text-white tracking-tight">Work Order Submitted!</h1>
          <p className="text-pbs-gray-500 dark:text-pbs-gray-400 mt-2">Your work order has been received. Our team will reach out to you shortly.</p>
        </div>
        <div className="inline-flex items-center gap-2 bg-white dark:bg-pbs-gray-900 border border-pbs-gray-200 dark:border-pbs-gray-700 rounded-2xl px-5 py-3">
          ...
          <span className="text-sm text-pbs-gray-500 dark:text-pbs-gray-400">Work order number:</span>
