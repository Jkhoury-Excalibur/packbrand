        ...
        await sendEmail({
          ...
          html: `
            <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto;">
              ...
              <a href="${escapeHtml(url)}" style="display: inline-block; padding: 12px 24px; background: #D32F2F; color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600;">Reset Password</a>
        ...
        await sendEmail({
          ...
          html: `
            <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto;">
              ...
              <a href="${escapeHtml(url)}" style="display: inline-block; padding: 12px 24px; background: #D32F2F; color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600;">Verify Email</a>
